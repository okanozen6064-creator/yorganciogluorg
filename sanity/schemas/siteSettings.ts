    ...
    fields: [
        ...
        defineField({
            ...
            fields: [
                ...
                defineField({ name: 'address', title: 'Adres', type: 'text', rows: 3, initialValue: 'Sütçüler, Şehit Astsubay ömer halisdemir caddesi Kepez devlet yhastanesi batı yönü Kepez Antalya' }),
            ]
        }),
        defineField({
            name: 'social',
